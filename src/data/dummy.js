...
export const EditorData = () => (
  <div>
    <h3>
      ...
      get started. Online Playgrounds If you&apos;re interested in playing
      ...
      simple demos. Add React to a Website You can add React to an HTML page in
      ...
      option. It only takes a minute to set up! As your application grows, you
      might want to consider a more integrated setup. There are several
      JavaScript toolchains we recommend for larger applications. Each of them
      can work with little to no configuration and lets you take full advantage
      of the rich React ecosystem. Learn how. Learn React People come to React
      from different backgrounds and with different learning styles. Whether you
      prefer a more theoretical or a practical approach, we hope you&apos;ll
      find this section helpful. If you prefer to learn by doing, start with our
      ...
      React examples with a live editor. Even if you don&apos;t know anything
      about React yet, try changing their code and see how it affects the
      result. React for Beginners If you feel that the React documentation goes
      at a faster pace than you&apos;re comfortable with, check out this
      overview of React by Tania Rascia. It introduces the most important React
      concepts in a detailed, beginner-friendly way. Once you&apos;re done, give
      the documentation another try! React for Designers If you&apos;re coming
      from a design background, these resources are a great place to get
      ...
      overview to check your knowledge level. It will take you between 30
      minutes and an hour but you will feel more confident learning React.
    </h3>
  </div>
);
